...
主席先生，我说你看起来像个鸡蛋，“爱丽丝轻轻地解释道。 “有些鸡蛋非常漂亮，你知道的，”她补充说，希望把她的话变成一种恭维话。

“有些人，”矮胖子说，像往常一样远离她，“没有比婴儿更有意义的了！

爱丽丝不知道该说些什么：她想，这完全不像谈话，因为他从来没有对她说过任何话。事实上，他最后一句话显然是写给了一棵树，于是她站起来，轻声重复着：
...
“通过镜子”。刘易斯·卡罗尔
看完片段后，尼古拉想要建立自己的“矮胖子”。作为一个基础，他选择了椭球体（在维基百科上阅读更多内容）。我们知道这个球体的高度和宽度（以英寸为单位）。对于手头的工作，尼古拉需要知道需要多少材料。
...
扁球体是橄榄球和澳大利亚橄榄球等几项运动中球的形状。在美式足球中，使用更尖锐的长椭球体。几个太阳系的卫星近似长椭球体，虽然它们实际上是斜角。例如Mimas，土卫二和特提斯绕轨道土星和米兰达围绕天王星。

地球的真实形状被称为扁圆球体，尽管它只是非常轻微的扁圆形。从北极到南极（最短直径）的直径约为12714公里。赤道直径（最长直径）约为12756公里。这不是一个很大的区别，但它确实意味着地球不是一个完全的球体。
'''
