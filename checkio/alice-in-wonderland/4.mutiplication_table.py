...
爱丽丝拿起扇子和手套，大厅里非常热，她一直在继续说：亲爱的，亲爱的！今天一切都很奇怪！而且昨天的情况和往常一样。我想知道我是否在夜间换了衣服？让我想想：今天早上起床的时候，我也一样吗？我几乎认为我可以记得有点不同。但如果我不一样，接下来的问题是，我是谁？啊，这是一个伟大的谜题！她开始思考所有她认识的和自己年纪相同的孩子，看看她们中的任何一个人是否可以改变。

“我敢肯定，我不是阿达，”她说，“因为她的头发长得很长，我的头发根本不会卷起来，而且我确定我不能成为梅贝尔，因为我知道各种各样的事情，她，哦，她知道这么少！另外，她是她，我是我，亲爱的，这是多么令人费解！我会试着如果我知道所有我曾经知道的事情，让我看看：五次四次十二次，四次六次十三次，四次七次 - 哦，亲爱的，我永远不会达到二十，但乘法表不会， t表示：...

“爱丽丝梦游仙境”刘易斯·卡罗尔
在阅读“爱丽丝梦游仙境”后，我们的机器人决定创建自己的“乘法表”。斯蒂芬会领导这个任务（是的，这可能是一个坏主意）。他忘了如何做乘法，并试图发明一种新的方法。如果我们这么直截了当，这是一个相当奇怪的方法。

在Stephan的乘法版本中，我们将数字转换为二进制表示而不用前导零。然后第一个数字垂直（从上到下）和第二个水平（从左到右）写入。这样，我们为每个交叉点填充一个表格，包括各种二进制操作 - AND，OR，XOR，所以我们最终得到三个表格。在每个表格中，我们将行转换为十进制并汇总，然后总结三个表的结果。我们来看几个例子。
