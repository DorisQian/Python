...
......“至于你，”她继续说道，猛烈地转向她认为是所有恶作剧的原因的红皇后 - 但是女王已经不在她的身边了 - 她突然缩小了，一个小娃娃的大小，现在在桌子上，高高兴兴地跑过她身后的披肩。

在其他任何时候，爱丽丝都会对此感到惊讶，但对于现在的任何事情，她都非常兴奋。 “至于你，”她重复道，抓住这个小动物跳过刚刚点亮的桌子上的一个瓶子，“我会把你甩成一只小猫，我会的！


第十章摇晃

她说话的时候，她把她从桌子上拿了下来，全身心地向前和向后摇了摇头。红皇后没有任何抵抗，只有她的脸变得非常小，眼睛变得又大又绿，而且，当爱丽丝继续摇着她的时候，她仍然越来越矮，越来越胖，越来越柔软，圆润，
...
“通过镜子”。刘易斯·卡罗尔
Doublets，有时被称为Word梯，是Charles Dodgson（又名Lewis Carroll）发明的文字游戏。双拼难题从两个单词开始。为了解决这个难题，必须找到一连串不同的单词将两者联系在一起，使得两个相邻的单词相差一个字母。

例如：FLOUR⇒FLOOR⇒FLOOD⇒BLOOD⇒BROOD⇒BROAD⇒BREAD

机器人喜欢使用数字而不是字母，所以我们已经改变了一些规则。你给出了完全相同长度的数字列表，你必须找到最短的数字链，把第一个数字和最后一个数字链接到最后一个数字。
