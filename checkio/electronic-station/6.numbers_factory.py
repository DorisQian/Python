...
How it is used: This task will teach you how to work with numbers in code. You can factorize numbers and reconstruct them 
into new numbers. Of course you can solve this problem with brute force, but is that the best way? Numbers are the foundation 
...
让我们看看这个例子。N = 20。我们可以把这个数分解成2 * 10，但10不是一个数字。也可以把它分解成4 * 5或2 *2* 5。2*2* 5的最小值
是225,4 *5 - 45。所以我们选择45。
...
如何使用:这个任务将教会你如何处理代码中的数字。你可以将数字分解并重新构造成新的数字。当然你可以用蛮力来解决这个问题，
但是这是最好的方法吗?数字是数学和编程的基础。
"""
def checkio(number):
