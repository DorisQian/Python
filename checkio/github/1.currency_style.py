...
许多国家对千位分隔符和小数点使用不同的约定。例如在荷兰，百万一千二百八十分之一写为1.001.200,80，而在美国则写为1,001,200.80。用你的编码技巧把第一种方式（荷兰，德国，俄罗斯，土耳其，巴西等）的美元换成第二种方式（美国，英国，加拿大，中国，日本，墨西哥等）。

只有以美元为单位的货币金额应该转换为：1.234,50美元到1,234.50美元，1.000美元到1,000美元以及4,57美元到4.57美元。但不要转换你的路由器的IP地址192.168.1.1。同样留下美元风格的货币不变。
