...
你多少岁了?这很容易计算——只要把你的生日从今天算起就行了。我们可以让这成为一个真正的挑战，并计算任何日期之间的区别。
你有两个日期作为元组与三个数字-年，月和日。例如:1982年4月19日是(1982年4月19日)。你应该在规定的日期之间找到不同的日期。例如今天和明天= 1天。差值总是正数或零，所以别忘了绝对值。

输入:两个日期为整数的元组。
输出:日期作为整数的日期之间的差异。

它是如何使用的:Python有电池，所以在这个任务中，你需要学习如何使用完成的模块，这样你就不用再重新发明自行车了。
