...
“迪-达-迪-达-达-达-达-达-达-达-达-德-达-达-达-达-达-达-达-达-达-德-达-达-德-达-达-德-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达-达
“你在做什么?”尼古拉好奇地问道。
“我把我们的时间记录发给了总部的最后一次探险，但这不是一件容易的事……”斯蒂芬抱怨道，“你能想象，在我们所有的计算机能力下，我仍然需要把这个信息转换成morse - code，只需要一个on / off按钮……”Hrmph……什么是痛苦。他对不便表示抱怨。
“让我看看。”Nikola提供了他的帮助，“这看起来是一个非常简单的解决方案，我们可以自动化这个过程。”
“哦. .你是我今天的英雄。“斯蒂芬开始兴奋地。“那么，我们该如何开始呢?”
“与Python !”尼古拉喊道。
帮助Stephen创建一个模块，用于将一个正常的时间字符串转换为莫尔斯时间字符串。正如您在插图中看到的，一个灰色的圆圈表示，而白色的圆圈表示关闭。小时的第一个数字的长度是2，而这个小时的第二个数字的长度是4。分钟和秒的第一个数字的长度为3，而分钟和秒的第二个数字的长度为4。时间中的每一个数字都转换成二进制表示形式。你将把每一个(或1)个信号转换为dash(“-”)，并将每一个(或0)信号转换为点(“。”)。

例子来源:维基百科
一个时间字符串可以是以下格式:“hh:mm:ss”，“h:m:s”或“hh:m:ss”。“缺失”的数字是零。例如，“1:2:3”和“01:02:03”是一样的。
...
如何使用:您是否看到了前面的二进制时钟任务?这对任何一个极客来说都是一件有趣的礼物。我们尝试将旧的好莫尔斯码与一个二进制时钟结合在这个任务中，现在你可以创建新的更复杂的二进制时钟，它不显示时间，但会制造莫尔斯风格的哔哔声和哔哔声。:-)
